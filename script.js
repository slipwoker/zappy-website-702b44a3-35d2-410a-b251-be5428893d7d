document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    function getFieldError(field) {
      ...
      if (field.tagName === 'TEXTAREA' && field.hasAttribute('minlength') && value !== '') {
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      const successMessage = contactForm.dataset.successMessage || 'Your message has been sent successfully!';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '702b44a3-35d2-410a-b251-be5428893d7d',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '702b44a3-35d2-410a-b251-be5428893d7d';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '702b44a3-35d2-410a-b251-be5428893d7d';
